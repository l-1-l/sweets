// https://github.com/Keats/validator/blob/master/validator/src/validation/ip.rs
...
#[must_use]
pub fn validate<'a, T>(val: T) -> bool
where
    T: Into<Cow<'a, str>>,
{
...
mod tests {
    ...
    //     for (input, expected) in tests {
    //         assert_eq!(is_v4(input), expected);
    //     }
    // }
    ...
    //     for (input, expected) in tests {
    //         assert_eq!(is_v6(input), expected);
    //     }
    // }
